import {
  DATA_VIEW_SYSTEM_PROMPT,
  DATA_VIEW_USER_PROMPT,
  OPENAI_USER_PROMPT,
...
}: // previousPreviews = [],
{
  ...
  const messages: GPT4VCompletionRequest["messages"] = [
    {
      ...
      content: DATA_VIEW_SYSTEM_PROMPT,
    },
    {
      role: "user",
      content: [],
  ...
  userContent.push({
    type: "text",
    text: /* previousPreviews?.length > 0 ? OPENAI_USER_PROMPT_WITH_PREVIOUS_DESIGN :  */ /* OPENAI_USER_PROMPT */ DATA_VIEW_USER_PROMPT,
  });
